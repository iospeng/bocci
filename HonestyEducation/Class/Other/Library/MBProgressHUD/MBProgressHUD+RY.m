...
- (void)addPopAnimation {
    ...
    scaleAnimation2.fromValue = [NSValue valueWithCGSize:CGSizeMake(1.0f, 1.0f)];
    scaleAnimation2.toValue = [NSValue valueWithCGSize:CGSizeMake(0.7f, 0.7f)];
    [self.layer pop_addAnimation:scaleAnimation2 forKey:@"scaleAnimation"];
}
